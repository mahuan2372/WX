...
export default {
  ...
  created: function mounted() {
    ...
    this.num = search.point;
    this.ruleId = search.ruleId;
    this.validDay =search.validDay;
    this.labels =search.dataList;
  ...
  methods: {
    ...
    getming: function(platCode, merId, memId) {
      this.localStorageState.set("details", { platCode: platCode, merId: merId, memId: memId });
      this.$router.push({
        path: "/jifenmingxi",
